...
|---|---|---|
| [echo.py](../../src/h3_harness/examples/echo.py) | `EchoHarness` | Full H3-compliant harness: session tracking, streaming detection, history echo. The battery-ready template (45/45 on h3-test). |
