...
| Module | Contents |
|---|---|
| `h3_harness` | Top-level re-exports (`__all__`): `BaseHarness`, `create_router`, `add_middleware`, and 21 protocol models/enums. `__version__` = `"0.1.6"` (resolved at import from install metadata / pyproject.toml — see GAP-068). |
